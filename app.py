            ...
            if sel_a_p:
                ...
                if nb_inputs_groupe > 0:
                    ...
                    if "MASTER" in tables_data:
                        ...
                        with st.expander(f"{label_master}", expanded=True):
                    ...
                    st.info("ℹ️ Veuillez renseigner le nombre de circuits d'entrées de l'artiste.")
        else:
