...
# Vérification de la compatibilité st.dialog
if not hasattr(st, "dialog"):
    st.error("⚠️ Votre version de Streamlit est trop ancienne. Veuillez mettre à jour : pip install --upgrade streamlit")
